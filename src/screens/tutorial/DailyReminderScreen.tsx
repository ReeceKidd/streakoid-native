...
type NavigationProps = {
    ...
    route: DailyRemindersScreenRouteProp;
};

type Props = ReturnType<typeof mapStateToProps> & ReturnType<typeof mapDispatchToProps> & NavigationProps;

class DailyRemindersSScreenComponent extends React.PureComponent<Props> {
    ...
    render(): JSX.Element {
        return (
            <View style={styles.container}>
                <Spacer>
                    <Text style={{ fontWeight: 'bold' }}>Do you want a daily reminder to complete your streaks?</Text>
                </Spacer>
                ...
                <Spacer>
                    <Button title="Next" onPress={() => this.props.navigation.navigate(Screens.TutorialComplete)} />
                </Spacer>
            </View>
        );
    }
...
const DailyReminderScreen = connect(mapStateToProps, mapDispatchToProps)(DailyRemindersSScreenComponent);

export { DailyReminderScreen };
